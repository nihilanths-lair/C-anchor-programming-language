...
Убрать препроцессором:
 +p comment=d file_name                              ; Комментарии не добавляются в новый файл с исходным кодом
 +p comment=d (без создания файла, для компилятора)  ; Комментарии в компилятор не попадают

Оставить препроцессором:
 +p comment=s file_name                              ; С сохранением комментариев в новом файле с исходным кодом
