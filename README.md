...
PUSH/push | Втолкнуть в стек
POP/pop | Вытолкнуть со стека
...
JNZ/jnz | Прыгни если не ноль   //  Jump if not zero  / if (!cmp('$', '$')) {} / if (1) {}
JNE/jne | Прыгни если не равно  //  Jump if not equal / if (!cmp('$', '$')) {} / if (1) {}
```
