...
-c=bc             ; Игнорировать компиляцию в байт-код
-c=bin            ; Игнорировать компиляцию в бинарный (сырой) код

+c=bin            ; Убран, не имеет смысла
+c=bc             ; Убран, не имеет смысла

-c=asm            ; Игнорировать компиляцию в ассемблерный код (По умолчанию)
+c=asm            ; Запустить скрытый механизм компиляции в ассемблерный код
+c=asm file_name  ; Запустить видимый процесс компиляции в ассемблерный код

+c=bin file_name  ; Включить видимую компиляцию в бинарный (сырой) код
+c=bc  file_name  ; Включить видимую компиляцию в байт-код
```
