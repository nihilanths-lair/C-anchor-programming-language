...
№ | Задача                                                                Реализовано?
1  Разбить цепочку лексем на токены                                            X
...
№ | Задача                                                                Реализовано?
1                                                                              X
Компонент/модуль: Генератор H-IR
№ | Задача                                                                                                                      Реализовано?
1   Из абстрактного синтаксического дерева (AST) сформировать линейное представление высокоуровневого IR (псевдокода)                X
Компонент/модуль: Генератор L-IR
№ | Задача                                                                                        Реализовано?
1   Из высокоуровневого линейного псевдокода сформировать низкоуровневый линейный псевдокод            X
Компонент/модуль: Оптимизатор кода (может применяться как над H-IR, так и над L-IR)
№ | Задача                                                                                        Реализовано?
