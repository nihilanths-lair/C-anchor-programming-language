...
```
                       Препроцессор  v.0.1
№                           Задачи                               Реализовано?
1  Удаление однострочных комментариев, без учёта вложенности          X
2  Удаление многострочных комментариев, без учёта вложенности         X
...
1  Разбить цепочку лексем на токены                                   X
                  Синтаксический анализатор (анализирует структуру)
1                                                                     X
                   Семантический анализатор (анализирует поведение)
1                                                                     X
```
```
-- - - - - - - - - - - - - --
