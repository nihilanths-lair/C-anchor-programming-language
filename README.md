...
¦ +c=cabc              ; --                                                                            ¦
¦ +c=cabc file_name    ; Запустить видимый механизм компиляции в байт-код                              ¦
+------------------------------------------------------------------------------------------------------+
+------------------------------------------------------------------------+
...
Убрать компилятором:
 +c comment=d file_name                              ; Комментарии не добавляются в новый файл с исходным кодом - file_name.asm
