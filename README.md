...
``` Архитектура VM ```
```
Регистры  8-bit's (9 шт.): ip8,  sp8,  dp8,  si8,  di8,  a8,  b8,  c8,  d8
Регистры 16-bit's (9 шт.): ip16, sp16, dp16, si16, di16, a16, b16, c16, d16
```
``` Таблица команд интерпретатора ```
```
-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - --
     Байт (СС)             Мнемоническая символика (синтаксис)
¦ в 16-й ¦ в 10-й ¦ ASCII ¦ на ассемблере ¦ на bf-подобном ¦ Операция
-- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - --
