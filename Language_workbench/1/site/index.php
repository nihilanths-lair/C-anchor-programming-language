...
<body style="background-color: #F0F0F0;">
  <h6>Последнее редактирование: 01/01/2026</h6>
  <br>
...
<?=$nbsp_1?>│<br>
<?=$nbsp_1?>├─›<span class="select-style">Новости<br></span><br>
<?=$nbsp_1?>│                 <?=$nbsp_2?>│<br>
<?=$nbsp_1?>│                 <?=$nbsp_2?>└─›От 01.01.2026:<br>
<?=$nbsp_1?>│<br>
<?=$nbsp_1?>│<?=$nbsp_6?>Начата работа над программным обеспечением.<br>
<?=$nbsp_1?>│<?=$nbsp_6?>Дата выхода бета-версии ожидается к 15/01/2026.<br>
<?=$nbsp_1?>│<?=$nbsp_6?>Незначительные обновления будут выходить раз в неделю, средние — раз в месяц, а крупные — один раз в полгода.<br>
<?=$nbsp_1?>│<br>
