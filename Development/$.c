...
{"\
0: .. Исходный код C$ (Через препроцессорный шаблон можно переопределить синтаксис для языка)\n\
1: print 2\n\
2: print 5 + 6\n\
3: печатать Привет мир!\n\
4: печатать на консоль Это моя первая программа.\n\
5: Вывод на консоль (Смотри как я могу!)\n\
6: Вывод на консоль [Смотри как я могу!]\n\
7: 100$(<Вау!>);\n\
8: puts(\"Стандартный синтаксис.\");\
"};
