...
001|01 - JMP/Jmp/jmp - переход (непосредственный прыжок) к метке, сравнимо с телепортацией с одного места в другое
002|02 - MOV/Mov/mov - поместить в ячейку памяти значение
-------------------------------------------------------------------------------------------------------
/*/