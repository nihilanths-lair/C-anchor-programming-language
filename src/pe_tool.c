...
void pe_analyzer()
{
    ...
    printf("\n /                        \\");
    printf("\n %c №2.1 | IMAGE NT HEADER %c", 16, 17);
    printf("\n \\________________________/");
    printf("\n ---------------------------------------------------------------------------------------------------------------------------------------------------------");
    offset = e_lfanew.value;
    if (fread(&pe_signature.value, 4, 1, descriptor) != 1) return;
    console_log(4, offset, pe_signature.bytes, pe_signature.value, "pe_signature");
    offset += 4;
    printf("\n ---------------------------------------------------------------------------------------------------------------------------------------------------------");
    printf("\n  __________________________");
    printf("\n /                          \\");
    printf("\n %c №2.2 | IMAGE FILE HEADER %c", 16, 17);
    printf("\n \\__________________________/");
    printf("\n ---------------------------------------------------------------------------------------------------------------------------------------------------------");
    ...
    if (Magic.value == 0x020B)
    {
        ...
        printf("\n /                                     \\");
        printf("\n %c №3 | OPTIONAL HEADER (PE32+/64-bit) %c", 16, 17);
        printf("\n \\_____________________________________/");
    }
    else if (Magic.value == 0x010B)
    {
        ...
        printf("\n /                                    \\");
        printf("\n %c №3 | OPTIONAL HEADER (PE32/32-bit) %c", 16, 17);
        printf("\n \\____________________________________/");
    }
    else
    {
