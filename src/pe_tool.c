...
void pe_analyzer()
{
    ...
    printf("\n -------------------------------------------------------------");
    printf("\n  040: %03d | 28: %02X | '%c' | uint16_t e_res2[10] = '\\0', №1",  dos_reserved[38], dos_reserved[38], to_ascii(dos_reserved[38]));
    printf("\n  041: %03d | 29: %02X | '%c' |                       '\\0',",     dos_reserved[39], dos_reserved[39], to_ascii(dos_reserved[39]));
    printf("\n  042: %03d | 2A: %02X | '%c' |                       '\\0', №2",  dos_reserved[40], dos_reserved[40], to_ascii(dos_reserved[40]));
    printf("\n  043: %03d | 2B: %02X | '%c' |                       '\\0',",     dos_reserved[41], dos_reserved[41], to_ascii(dos_reserved[41]));
    printf("\n  044: %03d | 2C: %02X | '%c' |                       '\\0', №3",  dos_reserved[42], dos_reserved[42], to_ascii(dos_reserved[42]));
    printf("\n  045: %03d | 2D: %02X | '%c' |                       '\\0',",     dos_reserved[43], dos_reserved[43], to_ascii(dos_reserved[43]));
    printf("\n  046: %03d | 2E: %02X | '%c' |                       '\\0', №4",  dos_reserved[44], dos_reserved[44], to_ascii(dos_reserved[44]));
    printf("\n  047: %03d | 2F: %02X | '%c' |                       '\\0',",     dos_reserved[45], dos_reserved[45], to_ascii(dos_reserved[45]));
    printf("\n  048: %03d | 30: %02X | '%c' |                       '\\0', №5",  dos_reserved[46], dos_reserved[46], to_ascii(dos_reserved[46]));
    printf("\n  049: %03d | 31: %02X | '%c' |                       '\\0',",     dos_reserved[47], dos_reserved[47], to_ascii(dos_reserved[47]));
    printf("\n  050: %03d | 32: %02X | '%c' |                       '\\0', №6",  dos_reserved[48], dos_reserved[48], to_ascii(dos_reserved[48]));
    printf("\n  051: %03d | 33: %02X | '%c' |                       '\\0',",     dos_reserved[49], dos_reserved[49], to_ascii(dos_reserved[49]));
    printf("\n  052: %03d | 34: %02X | '%c' |                       '\\0', №7",  dos_reserved[50], dos_reserved[50], to_ascii(dos_reserved[50]));
    printf("\n  053: %03d | 35: %02X | '%c' |                       '\\0',",     dos_reserved[51], dos_reserved[51], to_ascii(dos_reserved[51]));
    printf("\n  054: %03d | 36: %02X | '%c' |                       '\\0', №8",  dos_reserved[52], dos_reserved[52], to_ascii(dos_reserved[52]));
    printf("\n  055: %03d | 37: %02X | '%c' |                       '\\0',",     dos_reserved[53], dos_reserved[53], to_ascii(dos_reserved[53]));
    printf("\n  056: %03d | 38: %02X | '%c' |                       '\\0', №9",  dos_reserved[54], dos_reserved[54], to_ascii(dos_reserved[54]));
    printf("\n  057: %03d | 39: %02X | '%c' |                       '\\0',",     dos_reserved[55], dos_reserved[55], to_ascii(dos_reserved[55]));
