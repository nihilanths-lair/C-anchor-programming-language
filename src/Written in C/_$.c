// @ The minimum viable product of the temporary compiler for the permanent meta-compiler is 45.1% done.
// @ Минимально жизнеспособный продукт временного компилятора для постоянного мета-компилятора сделан на 45.1%.
//
#include <stdio.h>
#include <locale.h>
#include <ctype.h>
