...
static inline void Action()
{
    ...
    _case_2: // Операция сравнения
     ...
     //printf("\n <<| cf = %s", (cf) ? "true" : "false");
     //printf("\n memory[ip+=3] = %d", memory[ip+=3]);
     goto *action[memory[ip+=3]];
