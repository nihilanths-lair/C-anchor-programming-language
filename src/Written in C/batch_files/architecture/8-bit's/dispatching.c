...
void *dispatch_mode8[0x100] =
{
    ...
    [ 5] = &&dispatch__mode_8__identifier_opcode_6,  // <cmd=DEC>       <dst:m8> ; Декремент текущей ячейки памяти через прямую адресацию
    [ 6] = &&dispatch__mode_8__identifier_opcode_7,  // <cmd=DEC> <arg-1=dst:m8> ; Декремент произвольной ячейки памяти через прямую адресацию
    [ 7] = &&dispatch__mode_8__identifier_opcode_8,  // <cmd=DEC> <arg-1=dst:p8> ; Декремент произвольной ячейки памяти через косвенную адресацию
    ///////////////////////////////////////////////////
    [ 8] = &&dispatch__mode_8__identifier_opcode_9,  // <cmd=MOV> <arg-1=dst:m8> <arg-2=src:i8> ; l-op << r-op
    [ 9] = &&dispatch__mode_8__identifier_opcode_10, // <cmd=MOV> <arg-1=dst:p8> <arg-2=src:i8> ; l-op << r-op
    ///////////////////////////////////////////////////
    [10] = &&dispatch__mode_8__identifier_opcode_11, // <cmd=MOV> <arg-1=dst:m8> <arg-2=src:m8> ; l-op << r-op
    [11] = &&dispatch__mode_8__identifier_opcode_12, // <cmd=MOV> <arg-1=dst:p8> <arg-2=src:m8> ; l-op << r-op
    ///////////////////////////////////////////////////
    [12] = &&dispatch__mode_8__identifier_opcode_13, // <cmd=MOV> <arg-1=dst:m8> <arg-2=src:p8> ; l-op << r-op
    ///////////////////////////////////////////////////
    [13] = &&dispatch__mode_8__identifier_opcode_14, // <cmd=MOV dst:r8> <arg-1=src:i8> ; l-op = r-op
    [14] = &&dispatch__mode_8__identifier_opcode_15, // <cmd=MOV dst:r8> <arg-1=src:m8> ; l-op = r-op
    [15] = &&dispatch__mode_8__identifier_opcode_16, // <cmd=MOV dst:r8> <arg-1=src:p8> ; l-op = r-op
    ///////////////////////////////////////////////////
    [16] = &&dispatch__mode_8__identifier_opcode_17, // <cmd=MOV src:r8> <arg-1=dst:m8> ; l-op = r-op
    [17] = &&dispatch__mode_8__identifier_opcode_18, // <cmd=MOV src:r8> <arg-1=dst:p8> ; l-op = r-op
    ///////////////////////////////////////////////////
    [18] = &&dispatch__mode_8__identifier_opcode_19, // <cmd=MOV> <arg-1=src:i8> <arg-2=dst:m8> ; l-op >> r-op
    [19] = &&dispatch__mode_8__identifier_opcode_20, // <cmd=MOV> <arg-1=src:i8> <arg-2=dst:p8> ; l-op >> r-op
    ///////////////////////////////////////////////////
    [20] = &&dispatch__mode_8__identifier_opcode_21, // <cmd=MOV> <arg-1=src:m8> <arg-2=dst:m8> ; l-op >> r-op
    [21] = &&dispatch__mode_8__identifier_opcode_22, // <cmd=MOV> <arg-1=src:m8> <arg-2=dst:p8> ; l-op >> r-op
    ///////////////////////////////////////////////////
    [22] = &&dispatch__mode_8__identifier_opcode_23, // <cmd=MOV> <arg-1=src:p8> <arg-2=dst:m8> ; l-op >> r-op
    ///////////////////////////////////////////////////

    // Арифметико-логические операции
    ///////////////////////////////////////////////////
    [23] = &&dispatch__mode_8__identifier_opcode_24, // <cmd=ADD> <arg-1=dst:m8> <arg-2=src:i8>
    [24] = &&dispatch__mode_8__identifier_opcode_25, // <cmd=SUB> <arg-1=dst:m8> <arg-2=src:i8>
    [25] = &&dispatch__mode_8__identifier_opcode_26, // <cmd=MUL> <arg-1=dst:m8> <arg-2=src:i8>
    [26] = &&dispatch__mode_8__identifier_opcode_27, // <cmd=DIV> <arg-1=dst:m8> <arg-2=src:i8>
    ///////////////////////////////////////////////////
    ///////////////////////////////////////////////////
    // Переход в процедуру (8-bit's)                 //
    [27] = &&dispatch__mode_8__identifier_opcode_28, // <cmd=CALL> <arg-1=src:i8>
    [28] = &&dispatch__mode_8__identifier_opcode_29, // <cmd=CALL> <arg-1=src:m8>
    [29] = &&dispatch__mode_8__identifier_opcode_30, // <cmd=CALL> <arg-1=src:p8>
    // Возврат из процедуры (8-bit's)                //
    [30] = &&dispatch__mode_8__identifier_opcode_31, // <cmd=RET> ; Снимает значение-адрес со стека и совершает переход по нему
    // Управление стеком (8-bit's)                   //
    [31] = &&dispatch__mode_8__identifier_opcode_32, // <cmd=PUSH> <arg-1=src:i8> ; Заносимое значение-аргумент в стек пойдёт из непосредственного источника
    [32] = &&dispatch__mode_8__identifier_opcode_33, // <cmd=PUSH> <arg-1=src:m8> ; Заносимое значение-аргумент в стек пойдёт из памяти по прямому адресу
    [33] = &&dispatch__mode_8__identifier_opcode_34, // <cmd=PUSH> <arg-1=src:p8> ; Заносимое значение-аргумент в стек пойдёт из памяти по косвенному адресу
    //                                               //
    [34] = &&dispatch__mode_8__identifier_opcode_35, // <cmd=POP> <arg-1=dst:m8>  ; Снимаемое значение-аргумент со стека отправится по прямому адресу
    [35] = &&dispatch__mode_8__identifier_opcode_36, // <cmd=POP> <arg-1=dst:p8>  ; Снимаемое значение-аргумент со стека отправится по косвенному адресу
    ///////////////////////////////////////////////////
    // Сравнение (8-bit's)                           //
    [36] = &&dispatch__mode_8__identifier_opcode_37, // <cmd=CMP> <arg-1=src:i8> <arg-2=src:i8>
    [37] = &&dispatch__mode_8__identifier_opcode_38, // <cmd=CMP> <arg-1=src:m8> <arg-2=src:i8>
    [38] = &&dispatch__mode_8__identifier_opcode_39, // <cmd=CMP> <arg-1=src:i8> <arg-2=src:m8>
    [39] = &&dispatch__mode_8__identifier_opcode_40, // <cmd=CMP> <arg-1=src:m8> <arg-2=src:m8>
    //                                               //
    // Безусловный переход (8-bit's)                 //
    [40] = &&dispatch__mode_8__identifier_opcode_41, // <cmd=JMP> <arg-1=src:i8>
    [41] = &&dispatch__mode_8__identifier_opcode_42, // <cmd=JMP> <arg-1=src:m8>
    [42] = &&dispatch__mode_8__identifier_opcode_43, // <cmd=JMP> <arg-1=src:p8>
    ///////////////////////////////////////////////////
    // Условные переходы (8-bit's)                   //
    [43] = &&dispatch__mode_8__identifier_opcode_44, //      <cmd=JE> <arg-1=src:i8>  (Jump if Equal)
    [44] = &&dispatch__mode_8__identifier_opcode_45, //     <cmd=JNE> <arg-1=src:i8>  (Jump if Not Equal)
    [45] = &&dispatch__mode_8__identifier_opcode_46, //      <cmd=JB> <arg-1=src:i8>  (Jump if Below)
    [46] = &&dispatch__mode_8__identifier_opcode_47, //      <cmd=JA> <arg-1=src:i8>  (Jump if Above)
    [47] = &&dispatch__mode_8__identifier_opcode_48, // <cmd=JBE/JNA> <arg-1=src:i8>  (Jump if Below or Equal / Jump if Not Above)
    [48] = &&dispatch__mode_8__identifier_opcode_49, // <cmd=JAE/JNB> <arg-1=src:i8>  (Jump if Above or Equal / Jump if Not Below)
    ///////////////////////////////////////////////////////////////////////
    [49 ... 254] = &&dispatch__mode_8__identifier_opcode_from_50_to_255, // Неопределённые/неизвестные опкоды
    ///////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////
dispatch__mode_8__identifier_opcode_5: // <cmd=DEC> <dst:r8>
#include "..\..\ShowDashboard.txt"     //
...
/////////////////////////////////////////
/////////////////////////////////////////
dispatch__mode_8__identifier_opcode_6: // <cmd=DEC> <dst:m8>
#include "..\..\ShowDashboard.txt"     //
...
/////////////////////////////////////////
/////////////////////////////////////////
dispatch__mode_8__identifier_opcode_7: // <cmd=DEC> <arg-1=dst:m8>
#include "..\..\ShowDashboard.txt"     //
...
/////////////////////////////////////////
/////////////////////////////////////////
dispatch__mode_8__identifier_opcode_8: // <cmd=DEC> <arg-1=dst:p8>
#include "..\..\ShowDashboard.txt"     //
...
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_9:  // <cmd=MOV> <arg-1=dst:m8> <arg-2=src:i8> ; l-op << r-op (Intel)
...
//////////////////////////////////////////////////
dispatch__mode_8__identifier_opcode_10:         // <cmd=MOV> <arg-1=dst:p8> <arg-2=src:i8> ; l-op << r-op (Intel)
#include "..\..\ShowDashboard.txt"              //
...
//////////////////////////////////////////////////
dispatch__mode_8__identifier_opcode_11:         // <cmd=MOV> <arg-1=dst:m8> <arg-2=src:m8> ; l-op << r-op (Intel)
#include "..\..\ShowDashboard.txt"              //
...
// [Inserting abstract   C-code]: *a = b;
//////////////////////////////////////////////////////////
dispatch__mode_8__identifier_opcode_12:                 // <cmd=MOV> <arg-1=dst:p8> <arg-2=src:m8> ; l-op << r-op (Intel)
#include "..\..\ShowDashboard.txt"                      //
...
// [Inserting abstract   C-code]: a = *b;
//////////////////////////////////////////////////////////
dispatch__mode_8__identifier_opcode_13:                 // <cmd=MOV> <arg-1=dst:m8> <arg-2=src:p8> ; l-op << r-op (Intel)
#include "..\..\ShowDashboard.txt"                      //
...
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_14: // <cmd=MOV dst:r8> <arg-1=src:i8> ; l-op = r-op (Intel/AT&T)
#include "..\..\ShowDashboard.txt"      //
...
// [Inserting abstract   C-code]: -
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_15: // <cmd=MOV dst:r8> <arg-1=src:m8> ; l-op = r-op (Intel/AT&T)
#include "..\..\ShowDashboard.txt"      //
...
// [Inserting abstract   C-code]: -
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_16: // <cmd=MOV dst:r8> <arg-1=src:p8> ; l-op = r-op (Intel/AT&T)
#include "..\..\ShowDashboard.txt"      //
...
// [Inserting abstract   C-code]: -
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_17: // <cmd=MOV src:r8> <arg-1=dst:m8> ; l-op = r-op (Intel/AT&T)
#include "..\..\ShowDashboard.txt"      //
...
// [Inserting abstract   C-code]: -
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_18: // <cmd=MOV src:r8> <arg-1=dst:p8> ; l-op = r-op (Intel/AT&T)
#include "..\..\ShowDashboard.txt"      //
...
// [Inserting abstract   C-code]: a = 1;
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_19: // <cmd=MOV> <arg-1=src:i8> <arg-2=dst:m8> ; l-op >> r-op (AT&T)
...
// [Inserting abstract   C-code]: *a = b;    ; Предполагается, что в `b` уже находится какое-либо значение
//////////////////////////////////////////////////
dispatch__mode_8__identifier_opcode_20:         // <cmd=MOV> <arg-1=src:i8> <arg-2=dst:p8> ; l-op >> r-op (AT&T)
#include "..\..\ShowDashboard.txt"              //
...
// [Inserting abstract   C-code]: a = b;
//////////////////////////////////////////////////
dispatch__mode_8__identifier_opcode_21:         // <cmd=MOV> <arg-1=src:m8> <arg-2=dst:m8> ; l-op >> r-op (AT&T)
#include "..\..\ShowDashboard.txt"              //
...
// [Inserting abstract   C-code]: *a = b;
//////////////////////////////////////////////////////////
dispatch__mode_8__identifier_opcode_22:                 // <cmd=MOV> <arg-1=src:m8> <arg-2=dst:p8> ; l-op >> r-op (AT&T)
#include "..\..\ShowDashboard.txt"                      //
...
// [Inserting abstract   C-code]: a = *b;
//////////////////////////////////////////////////////////
dispatch__mode_8__identifier_opcode_23:                 // <cmd=MOV> <arg-1=src:p8> <arg-2=dst:m8> ; l-op >> r-op (AT&T)
#include "..\..\ShowDashboard.txt"                      //
...
///////////////////////////////////////////
dispatch__mode_8__identifier_opcode_24:  // <cmd=ADD> <arg-1=dst:m8> <arg-2=src:i8>
#include "..\..\ShowDashboard.txt"       //
 memory[memory[ip8+1]] += memory[ip8+2]; // <arg-1=dst:m8> <arg-2=src:i8>
 ip8 += 3;                               //
 goto *dispatch_mode8[memory[ip8]];      //
...
///////////////////////////////////////////
dispatch__mode_8__identifier_opcode_25:  // <cmd=SUB> <arg-1=dst:m8> <arg-2=src:i8>
#include "..\..\ShowDashboard.txt"       //
 memory[memory[ip8+1]] -= memory[ip8+2]; // <arg-1=dst:m8> <arg-2=src:i8>
 ip8 += 3;                               //
 goto *dispatch_mode8[memory[ip8]];      //
...
///////////////////////////////////////////
dispatch__mode_8__identifier_opcode_26:  // <cmd=MUL> <arg-1=dst:m8> <arg-2=src:i8>
#include "..\..\ShowDashboard.txt"       //
 memory[memory[ip8+1]] *= memory[ip8+2]; // <arg-1=dst:m8> <arg-2=src:i8>
 ip8 += 3;                               //
 goto *dispatch_mode8[memory[ip8]];      //
...
///////////////////////////////////////////
dispatch__mode_8__identifier_opcode_27:  // <cmd=DIV> <arg-1=dst:m8> <arg-2=src:i8>
#include "..\..\ShowDashboard.txt"       //
 memory[memory[ip8+1]] /= memory[ip8+2]; // <arg-1=dst:m8> <arg-2=src:i8>
 ip8 += 3;                               //
 goto *dispatch_mode8[memory[ip8]];      //
...
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_28: // <cmd=CALL> <arg1=src:i8>
#include "..\..\ShowDashboard.txt"      //
...
//////////////////////////////////////////
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_29: // <cmd=CALL> <arg1=src:m8>
#include "..\..\ShowDashboard.txt"      //
 memory[sp8--] = ip8+2;                 // Запоминаем адрес возврата из процедуры
...
//////////////////////////////////////////
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_30: // <cmd=CALL> <arg1=src:p8>
#include "..\..\ShowDashboard.txt"      //
 memory[sp8--] = ip8+2;                 // Запоминаем адрес возврата из процедуры
...
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_31: // <cmd=RET>
#include "..\..\ShowDashboard.txt"      //
...
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_32: // <cmd=PUSH> <arg1=src:i8>
#include "..\..\ShowDashboard.txt"      //
...
//////////////////////////////////////////
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_33: // <cmd=PUSH> <arg1=src:m8>
#include "..\..\ShowDashboard.txt"      //
...
//////////////////////////////////////////
//////////////////////////////////////////////////
dispatch__mode_8__identifier_opcode_34:         // <cmd=PUSH> <arg1=src:p8>
#include "..\..\ShowDashboard.txt"              //
...
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_35: // <cmd=POP> <arg1=dst:m8> ; Снимаемое значение-аргумент со стека отправится по прямому адресу
#include "..\..\ShowDashboard.txt"      //
...
//////////////////////////////////////////
//////////////////////////////////////////////////
dispatch__mode_8__identifier_opcode_36:         // <cmd=POP> <arg1=dst:p8> ; Снимаемое значение-аргумент со стека отправится по косвенному адресу
#include "..\..\ShowDashboard.txt"              //
...
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_37: // <cmd=CMP> <arg1=src:i8> <arg2=src:i8>
#include "..\..\ShowDashboard.txt"      //
...
//////////////////////////////////////////
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_38: // <cmd=CMP> <arg1=src:m8> <arg2=src:i8>
#include "..\..\ShowDashboard.txt"      //
...
//////////////////////////////////////////
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_39: // <cmd=CMP> <arg1=src:i8> <arg2=src:m8>
#include "..\..\ShowDashboard.txt"      //
 temp8_1 = memory[ip8+1];               // <arg1=src:i8>
...
//////////////////////////////////////////
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_40: // <cmd=CMP> <arg1=src:m8> <arg2=src:m8>
#include "..\..\ShowDashboard.txt"      //
 temp8_1 = memory[memory[ip8+1]];       // <arg1=src:m8>
 temp8_2 = memory[memory[ip8+2]];       // <arg2=src:m8>
 ef8 = (temp8_1 == temp8_2);            // ZF (Zero Flag) в x86
...
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_41: // <cmd=JMP> <arg1=src:i8>
#include "..\..\ShowDashboard.txt"      //
 ip8 = memory[ip8+1];                   // <arg1=src:i8>
 goto *dispatch_mode8[memory[ip8]];     //
//////////////////////////////////////////
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_42: // <cmd=JMP> <arg1=src:m8>
#include "..\..\ShowDashboard.txt"      //
 ip8 = memory[memory[ip8+1]];           // <arg1=src:m8>
 goto *dispatch_mode8[memory[ip8]];     //
//////////////////////////////////////////
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_43: // <cmd=JMP> <arg1=src:p8>
#include "..\..\ShowDashboard.txt"      //
 ip8 = memory[memory[memory[ip8+1]]];   // <arg1=src:p8>
 goto *dispatch_mode8[memory[ip8]];     //
//////////////////////////////////////////
...
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_44: //  JE addr8  (Jump if Equal)
#include "..\..\ShowDashboard.txt"      //
...
//////////////////////////////////////////
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_45: // JNE addr8  (Jump if Not Equal)
#include "..\..\ShowDashboard.txt"      //
...
//////////////////////////////////////////
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_46: //  JB addr8  (Jump if Below)
#include "..\..\ShowDashboard.txt"      //
...
//////////////////////////////////////////
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_47: //  JA addr8  (Jump if Above)
#include "..\..\ShowDashboard.txt"      //
...
//////////////////////////////////////////
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_48: // JBE/JNA addr8  (Jump if Below or Equal / Jump if Not Above)
#include "..\..\ShowDashboard.txt"      //
...
//////////////////////////////////////////
//////////////////////////////////////////
dispatch__mode_8__identifier_opcode_49: // JAE/JNB addr8  (Jump if Above or Equal / Jump if Not Below)
#include "..\..\ShowDashboard.txt"      //
...
//////////////////////////////////////////////////////
dispatch__mode_8__identifier_opcode_from_50_to_255: // ; Неопределённые опкоды
#include "..\..\ShowDashboard.txt"                  //
 putchar('\n');                                     //
