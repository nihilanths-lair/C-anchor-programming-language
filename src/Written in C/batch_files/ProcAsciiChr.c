...
const char * ProcAsciiChrDecodedText(const char chr)
{
    ...
    case 8: res = "\\08 "; break; //
    case 9: res = "\\09 "; break; //
    case 0x0A: res = "\\0A "; break; //
    case 0x0B: res = "\\0B "; break; //
    case 0x0C: res = "\\0C "; break; //
    case 0x0D: res = "\\0D "; break; //
    case 0x0E: res = "\\0E "; break; //
    case 0x0F: res = "\\0F "; break; //
    case 16: res = "\\10"; break; //
    case 17: res = "\\11"; break; //
    case 18: res = "\\12"; break; //
    case 19: res = "\\13"; break; //
    case 20: res = "\\14"; break; //
    case 21: res = "\\15"; break; //
    case 22: res = "\\16"; break; //
    case 23: res = "\\17"; break; //
    case 24: res = "\\18"; break; //
    case 25: res = "\\19"; break; //
    case 0x1A: res = "\\1A"; break; //
    case 0x1B: res = "\\1B"; break; //
    case 0x1C: res = "\\1C"; break; //
    case 0x1D: res = "\\1D"; break; //
    case 0x1E: res = "\\1E"; break; //
    case 0x1F: res = "\\1F"; break; //
    case ' ': res = "    "; break; // SP
    //
    case 'A': res = " A "; break;
    case 'B': res = " B "; break;
...
void mem_dbg(const char *m)
{
    ...
    for (int j = 0, j2; j < 16; j++)
    {
        ...
        putchar('\t');
        if (j2 >= 0 && j2 <= 255) printf("  %s: ", ProcAsciiChrEx((unsigned char) j2)); // графа в данных ASCII (1-я часть)
        for (int i = 0; i < 8; i++) printf("%s", ProcAsciiChrEx((unsigned char) m[j2+i])); // сами данные
        putchar('\n');
        //printf("\n\n");
        //printf("\n ------------------------------------------------------------------------------------------------------------------------\n");
