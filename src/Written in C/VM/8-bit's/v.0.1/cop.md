...
04 00        | 004 000      | JMP _0           | src:i8 | goto _0;       | .- произвольную ячейку памяти через непосредственную адресацию
05 XX        | 005 XXX      | JMP X            | src:m8 | goto cell[0];  | .- произвольную ячейку памяти через прямую адресацию
06 XX        | 006 XXX      | JMP [X]          | src:p8 | goto *cell[0]; | .- произвольную ячейку памяти через косвенную адресацию

                                                          Инкремент ..-

07           | 007          | INC r8           | dst:r8 | .- регистра r8
08           | 008          | INC m8           | dst:m8 | .- текущей ячейки памяти через прямую адресацию
...
0D           | 013          | DEC m8           | dst:m8 | .- текущей ячейки памяти через прямую адресацию
