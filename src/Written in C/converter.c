...
int main(int argc, char *argv[])
{
    ...
    /*
     На 1 оп-код = 1 путь
     На 2 оп-кода = 2 пути
     На 3 оп-кода = 6 путей
     На 4 оп-кода = 24 пути
     На 5 оп-кодов = 120 путей
     На 6 оп-кодов = 720 путей
     На 7 оп-кодов = 5'040 путей
     На 8 оп-кодов = 40'320 путей
     На 9 оп-кодов = 362'880 путей
     На 10 оп-кодов = 3'628'800 путей
    */
    /*
        [Принцип действия]:

        void *ident_1[] = {&&_1_1, &&_1_2, &&_1_3};
        void *ident_2[] = {&&_2_1, &&_2_2, &&_2_3};
        void *ident_3[] = {&&_3_1, &&_3_2, &&_3_3};
        void *ident_4[] = {&&_4_1, &&_4_2, &&_4_3};
        void *ident_5[] = {&&_5_1, &&_5_2, &&_5_3};
        void *ident_6[] = {&&_6_1, &&_6_2, &&_6_3};

        switch (TID_ISA){
        case 123: goto *ident_1[0~2];
        case 132: goto *ident_2[0~2];
        case 213: goto *ident_3[0~2];
        case 231: goto *ident_4[0~2];
        case 312: goto *ident_5[0~2];
        case 321: goto *ident_6[0~2];
        }

        _1_1: // <%1> = 0x00 = 0d000 = HLT/hlt 
        _1_2: // <%2> = 0x01 = 0d001 = JMP (8-bit's)
        _1_3: // <%3> = 0x02 = 0d002 = INC

        _2_1: // <%4> = 0x00 = 0d000 = HLT/hlt
        _2_2: // <%5> = 0x02 = 0d002 = INC
        _2_3: // <%6> = 0x01 = 0d001 = JMP (8-bit's)

        _3_1: // <%7> = 0x01 = 0d001 = JMP (8-bit's)
        _3_2: // <%8> = 0x00 = 0d000 = HLT/hlt
        _3_3: // <%9> = 0x02 = 0d002 = INC

        _4_1: // <%10> = 0x01 = 0d001 = JMP (8-bit's)
        _4_2: // <%11> = 0x02 = 0d002 = INC
        _4_3: // <%12> = 0x00 = 0d000 = HLT/hlt

        _5_1: // <%13> = 0x02 = 0d002 = INC
        _5_2: // <%14> = 0x00 = 0d000 = HLT/hlt
        _5_3: // <%15> = 0x01 = 0d001 = JMP (8-bit's)

        _6_1: // <%16> = 0x02 = 0d002 = INC
        _6_2: // <%17> = 0x01 = 0d001 = JMP (8-bit's)
        _6_3: // <%18> = 0x00 = 0d000 = HLT/hlt
    */
