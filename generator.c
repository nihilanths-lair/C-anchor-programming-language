...
void Main()
{
    ...
    fprintf(f, "    _%02X: goto *address[operation_code[OPERATION_CODE]]; // либо ++OPERATION_CODE, с 0x00\n", 0x100);
    fprintf(f, "    //----------------------------------------------------------------------------------------------------//\n");
    //----------------------------------------------------------------------------------------------------//
    ...
    fprintf(f, "    _%02X: // %s\n", ++count, "STOP");
    #if (DEBUG)
    fprintf(f, "     fprintf(f, \"Offset: [%%02X|%%03d], byte: [%%02X|%%03d]\", OPERATION_CODE, OPERATION_CODE, operation_code[OPERATION_CODE], operation_code[OPERATION_CODE]);\n");
    #endif
    fprintf(f, "     return 0;\n");
    fprintf(f, "    //----------------------------------------------------------------------------------------------------//\n");
    //----------------------------------------------------------------------------------------------------//
